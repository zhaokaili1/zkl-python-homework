...
使用shape则可以打印出三个数据表的维度。每个都是（114，42），即114行，42列。
```{python}
...
Mainland_china.plot(kind='barh', figsize=(20, 15), color = ['red','blue','lime'], width=1, rot=2)
...
sorted.plot(kind='barh', figsize=(20, 15), color = ['red','blue','lime'], width=1,rot=2)
